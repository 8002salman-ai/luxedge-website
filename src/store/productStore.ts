...
const initialProducts: Product[] = [
  ...
  {
    id: 'prod-019',
    name: 'ChillBreeze Portable Neck Fan',
    description: 'Hands-free bladeless neck fan with 3 speed settings, 360° airflow, and a rechargeable 4000mAh battery lasting up to 16 hours. Lightweight, whisper-quiet, and hair-safe — perfect for commutes, travel, and outdoor work. A viral summer bestseller on TikTok and Amazon.',
    price: 23.99,
    originalPrice: 42.99,
    category: 'Tech & Gadgets',
    stock: 140,
    images: [
      { id: 'img-20', url: 'https://images.pexels.com/photos/4491881/pexels-photo-4491881.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', isPrimary: true },
    ],
    rating: 4.6,
    reviewCount: 2734,
    sku: 'LE-FAN-001',
  ...
  {
    id: 'prod-020',
    name: 'RelaxEye Heated Eye Massager',
    description: 'Rechargeable heated eye massager with air-compression, gentle vibration, and soothing warmth to relieve eye strain, puffiness, and headaches. Built-in Bluetooth music, 5 modes, and a foldable travel design. A top self-care gadget trending on Amazon and AliExpress.',
    price: 38.99,
    originalPrice: 74.99,
    category: 'Wellness',
    stock: 82,
    images: [
      { id: 'img-21', url: 'https://images.pexels.com/photos/3865711/pexels-photo-3865711.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', isPrimary: true },
    ],
    rating: 4.7,
    reviewCount: 1988,
    sku: 'LE-EYE-001',
  ...
  {
    id: 'prod-021',
    name: 'PostureFix Smart Posture Corrector',
    description: 'Discreet smart posture corrector that gently vibrates when you slouch, retraining your back and shoulders for a healthier posture. Adjustable, breathable, and unisex — pairs with a free app to track progress. A viral wellness bestseller for desk workers.',
    price: 27.99,
    originalPrice: 49.99,
    category: 'Wellness',
    stock: 110,
    images: [
      { id: 'img-22', url: 'https://images.pexels.com/photos/4056723/pexels-photo-4056723.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', isPrimary: true },
    ],
    rating: 4.5,
    reviewCount: 1524,
    sku: 'LE-PST-001',
  ...
  {
    id: 'prod-022',
    name: 'AquaTrack Smart Water Bottle',
    description: 'Smart insulated stainless-steel water bottle with an LED hydration reminder and temperature display in the cap. Keeps drinks cold 24h / hot 12h, 500ml, BPA-free, and leak-proof. A trending health-and-fitness gadget across Amazon and TikTok.',
    price: 25.99,
    originalPrice: 46.99,
    category: 'Wellness',
    stock: 125,
    images: [
      { id: 'img-23', url: 'https://images.pexels.com/photos/1000084/pexels-photo-1000084.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', isPrimary: true },
    ],
    rating: 4.6,
    reviewCount: 2103,
    sku: 'LE-BTL-001',
  ...
  {
    id: 'prod-023',
    name: 'LumaStrip RGB LED Light Strip',
    description: '16ft app-controlled RGB LED light strip with 16 million colors, music sync, and voice control (Alexa & Google). Easy peel-and-stick install, remote included, and dimmable scenes for gaming setups and bedrooms. One of the top-selling home-decor items on Amazon.',
    price: 18.99,
    originalPrice: 35.99,
    category: 'Home & Living',
    stock: 198,
    images: [
      { id: 'img-24', url: 'https://images.pexels.com/photos/1616403/pexels-photo-1616403.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', isPrimary: true },
    ],
    rating: 4.7,
    reviewCount: 4562,
    sku: 'LE-LED-001',
  ...
  {
    id: 'prod-024',
    name: 'TurboVac Cordless Car Vacuum',
    description: 'Powerful 9000Pa cordless handheld vacuum for cars, desks, and pet hair. USB-C rechargeable, lightweight, and low-noise with washable HEPA filter and multiple nozzles. A best-selling car accessory trending on Amazon and AliExpress.',
    price: 29.99,
    originalPrice: 54.99,
    category: 'Tech & Gadgets',
    stock: 96,
    images: [
      { id: 'img-25', url: 'https://images.pexels.com/photos/4489732/pexels-photo-4489732.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940', isPrimary: true },
    ],
    rating: 4.5,
    reviewCount: 1876,
    sku: 'LE-VAC-001',
...
const initialCategories: Category[] = [
  { id: 'cat-1', name: 'Tech & Gadgets', productCount: 6 },
  { id: 'cat-2', name: 'Home & Living', productCount: 6 },
  { id: 'cat-3', name: 'Wellness', productCount: 8 },
